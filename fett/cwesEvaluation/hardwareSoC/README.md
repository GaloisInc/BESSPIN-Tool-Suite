...
This class includes the CWEs related to SoC design and hardware implementation. It encompasses the weaknesses tangent to mistakes in hardware design, mishandling permissions and boundaries, vulnerable transitions, DoS, side channels, cryptography componens, and various security elements.
