...
CAN_DLC_INFOTAINMENT_STATE: str = 1
...
CAN_DLC_CMD_COMPONENT_READY: str = 4
...
CAN_DLC_CMD_COMPONENT_ERROR: str = 8
...
CAN_DLC_CMD_ACTIVE_SCENARIO: str = 1
...
CAN_DLC_CMD_SET_DRIVING_MODE: str = 4
...
CAN_DLC_CMD_SCENARIO_NOT_AVAILABLE: str = 1
...
CAN_DLC_CMD_SCENARIO_AVAILABLE: str = 1
