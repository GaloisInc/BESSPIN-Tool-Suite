...
from besspin.cwesEvaluation.PPAC.cweScores.helpers import *

def test_301(logTest,testsDir):
    testNum = 301
    ...
    if (osImage in ['debian','FreeBSD']):
        return overallScore ([],testNum,msgIfNotImplemented="Not Implemented -- Protocol Level")
