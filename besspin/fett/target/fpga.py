...
class fpgaTarget(object):
    ...
    def fpgaStart (self, elfPath, elfLoadTimeout=15, isReload=False):      
        ...
        if (self.useOpenocd()):
            ...
            openocdCfg = os.path.join(getSetting('repoDir'),'besspin','target','utils',f'openocd_{cfgSuffix}.cfg')
    ...
    def startGdbDebug (self):
        ...
        printAndLog("Exit: Please <detach> then <quit> before exitting BESSPIN.")
