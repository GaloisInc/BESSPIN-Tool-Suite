...
NOTE: This module is shared between besspin.py and besspin-ci.py, so DO NOT IMPORT any functions
"""
...
@debugWrap
def sendSQS (urlQueue, exitFunc, status, jobId, nodeId, reason='besspin', hostIp='None', fpgaIp='None'):
...
def pollPortalIndefinitely (s3Bucket, mainProcess, exitFunc):
    ...
    keyPrefix = 'besspin/production/communication'
