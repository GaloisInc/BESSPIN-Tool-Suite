...
/*  cyberphysical_instrument_cluster_controller.ino
 ...
 *  
 *  FlexCAN library is pawelsky version available here:
 *  https://github.com/pawelsky/FlexCAN_Library
 *   
 */

#include <FlexCAN.h>  // see note above about FlexCAN library 
#include <kinetis_flexcan.h>
...
const unsigned char beamng_gear_drive = 0x0A;
...
// car lights
#define LEFT_TURN_SIGNAL 13
#define RIGHT_TURN_SIGNAL 15
#define BRAKE_LIGHT_R 14
#define BRAKE_LIGHT_L 16
...
unsigned char convert_gear_state_for_mfd(char gear) {
  ...
  switch (gear) {
    ...
    case beamng_gear_neutral:
      ...
      break;
    case beamng_gear_drive:
      return msg_0x418_D0_gear_drive;
      break;
...
// Create a FlexCAN object running on Can0 on the alternate pins
