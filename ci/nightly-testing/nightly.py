...
def ssh(names):
    ...
    for i in range(len(names)):
        ...
        for raw_file in filtered_raw_logs:
            ...
            os.system(
                f'touch tmp_logs/{ file } && echo "{ filename }" > tmp_logs/{ file }'
            )
