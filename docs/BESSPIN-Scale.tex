...
\begin{itemize}
    ...
    \item $\mathbf{SSITH}(\mathcal{C})$: The SSITH factor is a measure of how relevant the weakness category $\mathcal{C}$ is to the SSITH program. It can take the values: $1$ for strongly relevant, \nicefrac{2}{3} for relevant, and \nicefrac{1}{3} for somewhat relevant. 
\end{itemize} 
