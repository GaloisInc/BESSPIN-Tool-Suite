...
\href{https://github.com/DARPA-SSITH-Demonstrators/SSITH-FETT-Target/blob/develop/docs/cwesEvaluation/BESSPIN-Coeffs.md}{The BESSPIN coefficients document} contains all values used to compute the BESSPIN coefficients for each weakness category. They were evaluated by the BESSPIN team and DARPA.
